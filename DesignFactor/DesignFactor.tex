...
\begin{figure*}[t!]
  ...
  \subfloat[Shaft under bending]{
    \includegraphics[width=0.45\textwidth]{figs/fillet-bending.png}
  } & 
  \subfloat[Shaft under torsion]{
    \includegraphics[width=0.45\textwidth]{figs/fillet-torsion.png}
  } \\
  \end{tabular}
  \vspace{1em}
...
\begin{figure*}[t]
  ...
  \begin{tabular}{c c}
  \subfloat[Shaft under bending]{
    \includegraphics[width=0.45\textwidth]{figs/circlip-groove-bending.png}
  } & 
  \subfloat[Shaft under torsion]{
    \includegraphics[width=0.45\textwidth]{figs/circlip-groove-torsion.png}
  } \\
  \end{tabular}
  \vspace{1em}
